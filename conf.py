...
html_theme_options = {
   ...
   "footer_icons": [
    {
        "name": "GitHub",
        "url": "https://github.com/aabiddanda/",
        "html": """
    ...
    {
        "name": "Bluesky",
        "url": "https://bsky.app/profile/aabiddanda.bsky.social/",
        "html": """
    ...
    {
        "name": "Google Scholar",
        "url": "https://scholar.google.com/citations?user=BWVZXhgAAAAJ&hl=en",
        "html": """
...
html_static_path = ["_static", "_static/aabiddanda_cv.pdf"]
# html_css_files = []
html_css_files = [
      "css/override.css",
]
...
html_js_files = [
    'https://www.googletagmanager.com/gtag/js?id=G-ZXEQFEKF68',
