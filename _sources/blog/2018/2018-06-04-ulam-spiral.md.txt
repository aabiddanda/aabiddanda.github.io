...
```{image} ../../images/blog_images/ulam/ulam_primes.png
:width: 300px
:height: 300px
:align: center
```
...
```{image} ../../images/blog_images/ulam/ulam_num_div.png
:width: 500px
:height: 500px
:align: center
```

To recreate the figures in this post you can download or use the code from [this ipython notebook](https://gist.github.com/aabiddanda/6f7d73900bd598b5bfbe55b6a40bd395)
